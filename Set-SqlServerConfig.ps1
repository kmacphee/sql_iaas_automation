...
# authentication only. We need to do this in the execution context of the VM administrator until after we
# activate mixed mode authentication.
Invoke-Command -Credential $vmAdminCredential -ScriptBlock {
